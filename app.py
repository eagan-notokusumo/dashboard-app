...
app.layout = html.Div([ # this code section taken from Dash docs https://dash.plotly.com/dash-core-components/upload
    ...
    #                 html.H6('Built with Dash Plotly and Python')
    #             ]
    #         ),
    #         html.Div()
    #     ],
...
def algorithm(n, node_data, graph_data, num_paths, dest_node, source_data, updated_data): # Yen's algorithm
    ...
    results = costs_df.sort_values(by=['Value']).reset_index()

    
    print(type(result_all))
    print(result_all)
    cols = result_all.columns.to_list()
    cols = cols[-1:] + cols[:-1]
    cols.remove('Source')
    result_all = result_all[cols]
    rankings = result_all.astype(str).to_dict('records')
    # print(rankings)
        ...
        [
            ...
            html.Div(
                dash_table.DataTable(
                    ...
                    export_format='csv',
                    page_size=25,
                    style_table={'height': '300px', 'overfloyY': 'auto'},
